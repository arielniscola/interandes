...
export const generateInstructivoPDF = async (
  sales: ISalesOrder,
  ...
  try {
    ...
    const stream = fs.createWriteStream("files/instructivo.pdf");
    doc.pipe(stream);
    ...
    drawCell(`${sales.numberSO}`, 300, 100, 100, 20, "center");
    drawCell("CUSTOMER", 200, 120, 100, 20, "center");
    drawCell(`(Usuario)`, 300, 120, 100, 20, "center");
    ...
    drawCell(`${client.companyname}`, 280, 165, 250, 15, "center", "Helvetica");
    drawCell("DESPACHANTE", 30, 180, 250, 15, "center");
    drawCell(sales.customsBroker, 280, 180, 250, 15, "center", "Helvetica");
    drawCell("FECHA DE CARGA", 30, 195, 250, 15, "center");
    drawCell(
      `${moment(sales.chargeDate).format("DD/MM/YYYY")}`,
      280,
      195,
      250,
      15,
    ...
    drawCell(sales.chargeLocation, 280, 210, 250, 15, "center", "Helvetica");
    ...
    drawCell(sales.invoicePO, 280, 240, 250, 15, "center", "Helvetica");
    drawCell("DESTINO FINAL", 30, 255, 250, 15, "center");
    drawCell(sales.finalDestination, 280, 255, 100, 15, "center", "Helvetica");
    ...
    drawCell(sales.transportation, 280, 270, 250, 15, "center", "Helvetica");
    drawCell("BANDERA", 30, 285, 250, 15, "center");
    drawCell(sales.flag, 280, 285, 250, 15, "center", "Helvetica");
    drawCell("ATA/CUIT", 30, 300, 250, 15, "center");
    drawCell(sales.landedATA, 280, 300, 250, 15, "center", "Helvetica");
    ...
    drawCell(sales.maritimeATA, 280, 330, 250, 15, "center", "Helvetica");
    drawCell("POL", 30, 345, 250, 15, "center");
    drawCell("", 280, 345, 250, 15, "center", "Helvetica");
    drawCell("NAVIERA", 30, 360, 250, 15, "center");
    drawCell(sales.shippingLine, 280, 360, 250, 15, "center", "Helvetica");
    drawCell("BUQUE/ETS", 30, 375, 250, 15, "center");
    drawCell(sales.vessel, 280, 375, 250, 15, "center", "Helvetica");
    drawCell("VIAJE/BANDERA", 30, 390, 250, 15, "center");
    drawCell(sales.voyage, 280, 390, 250, 15, "center", "Helvetica");
    drawCell("CUT OFF FISICO", 30, 405, 250, 15, "center");
    drawCell(
      `${moment(sales.physicalCutOffDate).format("DD/MM/YYYY HH:MM:SS")}`,
      280,
      405,
      250,
      15,
    ...
    drawCell(
      `${moment(sales.documentaryCutOffDate).format("DD/MM/YYYY HH:MM:SS")}`,
      280,
      420,
      250,
      15,
    ...
    drawCell(sales.booking, 280, 435, 250, 15, "center", "Helvetica");
